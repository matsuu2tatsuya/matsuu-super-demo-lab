...
顧客の基準は厳しく、平らな塗装面に線状の引っかき傷が 1 本でもあれば長さを問わず NG(severity は major)。塗装が剥がれて下地が見えている箇所、指で触って分かる凹みも NG。
箱の角やエッジ(稜線)に沿った擦れ・明るい線は、面取り部の光の反射や通常の当たりなので不良ではない。どうしても気になる場合も軽微(minor)に留める。
